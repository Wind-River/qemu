...
class SabreliteVxWorksTest(QemuSystemTest):
    ...
    def test_vxworks_boot(self):
        ...
        The VxWorks image and DTB are expected to be provided by an SDK
        installed at a path defined by the QEMU_TEST_VXWORKS_SABRELITE_SDK
        environment variable (default: /opt/wrsdk/wrsdk-vxworks7-qemu-sabrelite).
        """
